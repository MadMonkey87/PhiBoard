...
struct Widget_MultiButton_Definition : Widget_Base_Definition
{
};
...
public:
    PHI_Widget_Multi_Button(int16_t x, int16_t y, int16_t w, int16_t h, int16_t items, Widget_MultiButton_Definition *definition);
...
protected:
    Widget_MultiButton_Definition *_definition;
