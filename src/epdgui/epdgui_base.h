...
public:
    ...
    virtual void BindEvent(int16_t event, void (*func_cb)(epdgui_args_vector_t &)) = 0;
    virtual void UpdateTouchState(int16_t x, int16_t y) = 0;
    ...
    void UpdateGraphicsMode(m5epd_update_mode_t mode = UPDATE_MODE_DU4);
